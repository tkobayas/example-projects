...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="test-util" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.tools.IntegrationTestUtil %CMD_LINE_ARGS%
