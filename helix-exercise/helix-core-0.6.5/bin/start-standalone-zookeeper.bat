...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="start-standalone-zookeeper" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.tools.LocalZKServer %CMD_LINE_ARGS%
