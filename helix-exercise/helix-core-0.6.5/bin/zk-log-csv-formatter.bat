...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="zk-log-csv-formatter" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.tools.ZkLogCSVFormatter %CMD_LINE_ARGS%
