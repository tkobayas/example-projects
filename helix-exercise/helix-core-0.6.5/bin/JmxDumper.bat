...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="JmxDumper" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.tools.JmxDumper %CMD_LINE_ARGS%
