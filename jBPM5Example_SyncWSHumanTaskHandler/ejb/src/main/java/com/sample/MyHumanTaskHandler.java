...
public class MyHumanTaskHandler implements WorkItemHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MyHumanTaskHandler.class);
    ...
    public MyHumanTaskHandler() {
    	this.action = OnErrorAction.LOG;
    }

    public MyHumanTaskHandler(TaskService client) {
        this.client = client;
        this.action = OnErrorAction.LOG;
    }
    
    public MyHumanTaskHandler(TaskService client, KnowledgeRuntime session) {
        this.client = client;
        this.session = session;
        this.action = OnErrorAction.LOG;
    }
    
    public MyHumanTaskHandler(TaskService client, OnErrorAction action) {
        this.client = client;
        this.action = action;
    }
    
    public MyHumanTaskHandler(TaskService client, KnowledgeRuntime session, OnErrorAction action) {
        this.client = client;
        this.session = session;
        this.action = action;
    }
    ...
    public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
        ...
        // get a list of actors from somewhere
        String actorId = "Jabba Hutt, Christoper Columbus";
